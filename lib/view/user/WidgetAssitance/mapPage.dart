...
class _HomeState extends State<MapPage> {
  ...
  String googleAPiKey =
      "AIzaSyDD3gyUFBbw37LtBDt4YtgCzmI_TiNY7Bs";

  Set<Marker> markers = Set(); //markers for google map
  Map<PolylineId, Polyline> polylines = {}; //polylines to show direction

    //// start and end location ////////////////////////
  LatLng location1 = LatLng(30.139259896517608, 31.66203864459031);
  LatLng location2 = LatLng(30.16765827883763, 31.61579178146941);
    LatLng location3 = LatLng(30.165322214151793, 31.6199100475472);

  LatLng location4 = LatLng(30.170582689227615, 31.621423708961487);
  ...
  void initState() {
    markers.add(Marker(
      ...
      position: location1, //position of marker
    ...
    markers.add(Marker(
      ...
      position: location2, //position of marker
      infoWindow: InfoWindow(
        //popup info
        title: 'location two  ',
